# Triton version for larger datasets adapted by Simo Tuomisto
#
...
times[1, 1] <- timing
cat(c("Creation, transp., deformation of a 5000x5000 matrix (sec): ", timing, "\n"))
remove("a", "b")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
cumulate <- 0; b <- 0
for (i in 1:runs) {
  a <- abs(matrix(Rnorm(5000*5000)/2, ncol=5000, nrow=5000));
  invisible(gc())
...
timing <- cumulate/runs
times[2, 1] <- timing
cat(c("5000x5000 normal distributed random matrix ^1000____ (sec): ", timing, "\n"))
remove("a", "b")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
timing <- cumulate/runs
times[3, 1] <- timing
cat(c("Sorting of 15,000,000 random values__________________ (sec): ", timing, "\n"))
remove("a", "b")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
for (i in 1:runs) {
  a <- new("dgeMatrix", x = Rnorm(5000*5000), Dim = as.integer(c(5000,5000)))
  b <- as.double(1:5000)
  invisible(gc())
...
timing <- cumulate/runs
times[5, 1] <- timing
cat(c("Linear regr. over a 5000x5000 matrix (c = a \\ b')___ (sec): ", timing, "\n"))
remove("a", "b", "c", "qra")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
timing <- cumulate/runs
times[1, 2] <- timing
cat(c("FFT over 5,000,000 random values____________________ (sec): ", timing, "\n"))
remove("a", "b")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
cumulate <- 0; b <- 0
for (i in 1:runs) {
  a <- array(Rnorm(1500*1500), dim = c(1500, 1500))
...
timing <- cumulate/runs
times[2, 2] <- timing
cat(c("Eigenvalues of a 1500x1500 random matrix______________ (sec): ", timing, "\n"))
remove("a", "b")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
cumulate <- 0; b <- 0
for (i in 1:runs) {
  a <- crossprod(new("dgeMatrix", x = Rnorm(5000*5000),
                       Dim = as.integer(c(5000, 5000))))
  invisible(gc())
...
timing <- cumulate/runs
times[4, 2] <- timing
cat(c("Cholesky decomposition of a 5000x5000 matrix________ (sec): ", timing, "\n"))
remove("a", "b")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
cumulate <- 0; b <- 0
for (i in 1:runs) {
  a <- new("dgeMatrix", x = Rnorm(3000*3000), Dim = as.integer(c(3000, 3000)))
  invisible(gc())
...
timing <- cumulate/runs
times[5, 2] <- timing
cat(c("Inverse of a 3000x3000 random matrix________________ (sec): ", timing, "\n"))
remove("a", "b")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
timing <- cumulate/runs
times[1, 3] <- timing
cat(c("7,000,000 Fibonacci numbers calculation (vector calc)(sec): ", timing, "\n"))
remove("a", "b", "phi")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()

# (2)
cumulate <- 0; a <- 5000; b <- 0
for (i in 1:runs) {
  invisible(gc())
...
timing <- cumulate/runs
times[2, 3] <- timing
cat(c("Creation of a 5000x5000 Hilbert matrix (matrix calc) (sec): ", timing, "\n"))
remove("a", "b")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
timing <- cumulate/runs
times[3, 3] <- timing
cat(c("Grand common divisors of 1,000,000 pairs (recursion)__ (sec): ", timing, "\n"))
remove("a", "b", "c", "gcd2")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
cumulate <- 0; b <- 0
for (i in 1:runs) {
  b <- rep(0, 1000*1000); dim(b) <- c(1000, 1000)
  invisible(gc())
  timing <- system.time({
...
timing <- cumulate/runs
times[4, 3] <- timing
cat(c("Creation of a 1000x1000 Toeplitz matrix (loops)_______ (sec): ", timing, "\n"))
remove("b", "j", "k")
if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
...
for (i in 1:runs) {
  x <- abs(Rnorm(100*100)); dim(x) <- c(100, 100)
  invisible(gc())
...
times[5, 3] <- timing
cat(c("Escoufier's method on a 100x100 matrix (mixed)________ (sec): ", timing, "\n"))
