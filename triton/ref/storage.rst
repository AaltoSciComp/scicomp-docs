.. csv-table::
   ...
   XDG Runtime Directory (ramfs)   | ``$XDG_RUNTIME_DIR``                    | limited by memory           | -         | single-node                    | Ramfs on the compute nodes with files cached in the memory.  Small random-access data (https://standards.freedesktop.org/basedir-spec/basedir-spec-latest.html).
