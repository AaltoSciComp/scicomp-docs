...
*Nov 25–27, 2025* `Python for Scientific Computing 2025 </training/scip/python-for-scicomp-2025/>`__ — online course run in collaboration with CodeRefinery, CSC, and LUMI partners.

*Sep 9–Oct 22, 2025* `CodeRefinery workshop <https://coderefinery.github.io/2025-09-09-workshop/>`__ — git, reproducibility, and coding practices. Open to all.

*Sep–Oct 2025* SCI-L1010 Scientific Computing Skills: a new umbrella course for doctoral researchers (up to 5 ECTS), running Sep 9–Oct 22.

*Aug 26, 2025* `Announcement: SCI-L1010 Scientific Computing Skills officially launched <https://www.aalto.fi/en/news/scientific-computing-skills-a-new-umbrella-course-for-all-researchers>`__ — a new umbrella course for all researchers at Aalto.

*Aug 21, 2025* `ML on HPC: Advanced Workflows and Tools <https://www.aalto.fi/en/events/machine-learning-on-hpc-advanced-workflows-and-tools>`__ — online session by ASC, CSC, and LUMI AI Factory, covering GPU job arrays and HuggingFace Accelerate.

*Jun 3–5, 2025* `HPC Summer Kickstart 2025 </training/scip/kickstart-2025/>`__: Introduction to Scientific Computing and HPC — open to all Nordic HPC users.

*Jun 2025* New documentation page: `Responsible Conduct of Computational Research </scicomp/rcr-scicomp/>`__.

*May–Jun 2025* Major rewrite of Python/conda environment documentation.

*May 27, 2025* Triton module system updated to hierarchical software stacks — documentation fully updated to reflect the new structure.

*May 23, 2025* New page: Hyperparameter Optimization (HPO) on Triton.

*Apr 14–15, 2025* `Practical Deep Learning with PyTorch on LUMI <https://www.aalto.fi/en/events/practical-deep-learning-1415april2025>`__ — by CSC/LUMI AI Factory, hosted at Aalto.

*Feb 26, 2025* `HPC Winter Kickstart 2025 </training/scip/winter-kickstart-2025/>`__: Introduction to Triton and HPC.
...
*10/05/2021* CodeRefinery online workshop starts today. Tune in for git intro part 1. If you did not register, you can watch via Twitch: https://www.twitch.tv/coderefinery
...
*14/01/2021* Save the date: `29 January 2021: Crash course on Data Science workflows at Aalto + Linux terminal basics <https://scicomp.aalto.fi/training/scip/intro-linux-aalto-computing/>`__ in preparation for `1-2 February 2021: Triton Winter Kickstart <https://scicomp.aalto.fi/training/scip/winter-kickstart/>`__. Registration link can be found within the course pages. Kickstart course is highly recommended to new Triton HPC users.
...
*16/10/2020* Today the fourth and last part of our course on `Data analysis workflows with R and Python <https://scicomp.aalto.fi/training/scip/data-analysis/>`__. You can watch it on `CodeRefinery Twitch channel <https://www.twitch.tv/coderefinery>`__.
...
*28/09/2020* Friendly reminder that you can still register for our `Data analysis workflows with R and Python <https://scicomp.aalto.fi/training/scip/data-analysis/>`__. Also save the date: Mon 19/10/2020 at 14:00 "Triton users group meeting", come and hear about the future of Triton/ScienceIT/Aalto Scientific Computing, exciting news on new services, new hardware (GPUs!), and anything related to Aalto Scientific Computing.

*25/09/2020* Friendly reminder that you can still register for our `Data analysis workflows with R and Python <https://scicomp.aalto.fi/training/scip/data-analysis/>`__.
...
*22/09/2020* Join us tonight (21:30 Helsinki time), for `Research Software Hour <https://researchsoftwarehour.github.io/>`__, a one hour interactive discussion with Radovan Bast and Richard Darst. Tonight we cover command line arguments and running things in parallel.

*21/09/2020* This week is the last week of our course on `"Python for Scientific Computing" </training/scip/python-for-scicomp>`__. You can re-watch the lessons on `CodeRefinery Twitch channel <https://www.twitch.tv/coderefinery>`__.
