...
The service is currently hosted on `https://llm-gateway.k8s.aalto.fi <https://llm-gateway.k8s.aalto.fi>`` and 
...
model size, take a substantial time for them to spin up.
...
plenty of opportunity for scaling and the models do scale to some extent.
